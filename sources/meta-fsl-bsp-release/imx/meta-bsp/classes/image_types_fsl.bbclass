...
generate_imx_sdcard () {
	...
	##parted -s ${SDCARD} unit KiB mkpart primary $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED}) $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED} \+  $ROOTFS_SIZE)
        parted -s ${SDCARD} unit KiB mkpart primary $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED}) $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED} \+ ${PARAMS_SPACE_ALIGNED})
        parted -s ${SDCARD} unit KiB mkpart primary $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED} \+ ${PARAMS_SPACE_ALIGNED}) $(expr ${IMAGE_ROOTFS_ALIGNMENT} \+ ${BOOT_SPACE_ALIGNED} \+ ${PARAMS_SPACE_ALIGNED} \+ $ROOTFS_SIZE)
	parted ${SDCARD} print
	...
	dd if=${SDCARD_ROOTFS} of=${SDCARD} conv=notrunc,fsync seek=1 bs=$(expr ${BOOT_SPACE_ALIGNED} \* 1024 + ${IMAGE_ROOTFS_ALIGNMENT} \* 1024 +  ${PARAMS_SPACE_ALIGNED} \* 1024)
}
...
IMAGE_CMD_sdcard () {
	...
	BOOT_SPACE_ALIGNED=$(expr ${BOOT_SPACE_ALIGNED} - ${BOOT_SPACE_ALIGNED} % ${IMAGE_ROOTFS_ALIGNMENT})
        ...
        PARAMS_SPACE_ALIGNED=$(expr ${PARAMS_SIZE} + ${IMAGE_ROOTFS_ALIGNMENT} - 1)
        PARAMS_SPACE_ALIGNED=$(expr ${PARAMS_SPACE_ALIGNED} - ${PARAMS_SPACE_ALIGNED} % ${IMAGE_ROOTFS_ALIGNMENT})

	SDCARD_SIZE=$(expr ${IMAGE_ROOTFS_ALIGNMENT} + ${BOOT_SPACE_ALIGNED} + ${PARAMS_SPACE_ALIGNED} + $ROOTFS_SIZE + ${IMAGE_ROOTFS_ALIGNMENT})
